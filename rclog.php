 ...
 <div class="lol" style="width:1000px; margin-right:auto; margin-left:auto;">
		<div class="panel widget-notifications">
					<div class="panel-heading">
						<span class="panel-title"><i class="panel-title-icon fa fa-briefcase"></i>RCoins pieprasījumu pārskats</span>
					</div>
...
$orgq = "SELECT * FROM rcquest ORDER by id DESC LIMIT $start_from, $per_page";
...
if($what == 0)
{
	$what = "Gaida apstiprinājumu";
	echo "<div class='notification'><div class='notification-title text-warning'>".$what."</div><div class='notification-description'><strong>#".$bans['id']."</strong> Spēlētāja <strong>".$bans['no']."</strong> pieprasījums pārskaitīt <strong>".$bans['rc']."</strong> RCoins spēlētājam <strong>".$bans['uz']."</strong> ir izskatīšanā!</div><div class='notification-ago'>".$time."</div><div class='notification-icon fa fa-hdd-o bg-warning'></div></div>";
}
else if($what == 1)
{
	$what = "Pieņemts";
	echo "<div class='notification'><div class='notification-title text-success'>".$what."</div><div class='notification-description'><strong>#".$bans['id']."</strong> Spēlētāja <strong>".$bans['no']."</strong> pieprasījums pārskaitīt <strong>".$bans['rc']."</strong> RCoins spēlētājam <strong>".$bans['uz']."</strong> tika akceptēts!</div><div class='notification-ago'>".$time."</div><div class='notification-icon fa fa-hdd-o bg-success'></div></div>";
}
else if($what == 2)
{
	$what = "Noraidīts";
	echo "<div class='notification'><div class='notification-title text-danger'>".$what."</div><div class='notification-description'><strong>#".$bans['id']."</strong> Spēlētāja <strong>".$bans['no']."</strong> pieprasījums pārskaitīt <strong>".$bans['rc']."</strong> RCoins spēlētājam <strong>".$bans['uz']."</strong> tika noraidīts!</div><div class='notification-ago'>".$time."</div><div class='notification-icon fa fa-hdd-o bg-danger'></div></div>";
}
}
while ($bans = mysqli_fetch_array($orgres));
}
...
?>
					...
					if($mm == 0)
					{
						...
						<li><a href='rclog.php?page=".$aa."'>Vecākie →</a></li>";
					}
					else if($mm > 0)
					{
						if($total_pages < $aa)
						{
							echo "<li><a href='rclog.php?page=".$mm."'>← Jaunākie</a></li>
