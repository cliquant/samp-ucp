...
<center><nav class="navbar navbar-default"  style="width:1000px;margin-left:0px;margin-top:2px;">
			<div class="container-fluid">
				...
				<script>
					init.push(function () {
						$('#bans').dataTable();
						$('#bans_wrapper .table-caption').text('Banu saraksts');
					...
					<div class="panel-body">
						<div class="table-primary">
							<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="bans">
								...
								<tbody>
								<?php 
$orgq = "SELECT * FROM bans ORDER by id DESC";
...
if($t > $l)
{
	$banstatus="<span class='label label-success'>Beidzies</span>";
}
else if($t < $l)
{
	$banstatus="<span class='label label-danger'>Aktīvs</span>";
}
    echo "<tr class='gradeA'><td>".$bans['name']."</td><td>".$bans['whobanned']."</td><td>".$bans['ip']."</td><td>".$bans['reason']."</td><td>".$bans['time']."</td><td>".$banstatus."</td></tr>";
}
while ($bans = mysqli_fetch_array($orgres));
}
?>
