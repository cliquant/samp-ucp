...
<script>
					init.push(function () {
						$('#bans').dataTable();
						$('#bans_wrapper .table-caption').text('PaintBall 100 labākie');
					...
					<div class="panel-body">
								...
								<div class="table-primary">
									...
									<table class="table table-bordered">
										...
										<tbody>
										<?php 
$orgq = "SELECT name,leader,assistant FROM fraction WHERE name != 'None'";
...
do
{
	...
	$paligs = $bans['assistant'];
	if($paligs == "None")
	{
		$paligs = "Brīvs";
	}
    echo "<tr class='gradeA'><td>".$a."</td><td>".$bans['name']."</td><td>".$lideris."</td><td>".$paligs."</td></tr>";
}
while ($bans = mysqli_fetch_array($orgres));
}
?>
