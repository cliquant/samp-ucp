...
<div class="alert alert-info alert-dark" style="width:1000px; margin-left:auto; margin-right:auto;">
							<strong>Svarīgi!</strong> Seko līdzi servera atjauninājumiem forumā.
						</div>
						<div class="alert alert-succes alert-dark" style="width:1000px; margin-left:auto; margin-right:auto;">
							<strong>Jaunums!</strong> Atjaunota intro un automašīnu lapa, kur var apskatīt tagad visus auto!<p>22/03/2018</p>
						</div>
<?php
...
$chat = $db->query(
	"SELECT post,topic_id,post_date FROM ".$INFO['sql_tbl_prefix']."posts WHERE author_id = 3 AND use_sig = 0 AND new_topic = 1 ORDER BY post_date DESC LIMIT 2");
while($shout = $chat->fetch_object()) {
	$topic = $db->query(
	"SELECT title,starter_name FROM ".$INFO['sql_tbl_prefix']."topics WHERE tid = '$shout->topic_id' LIMIT 1");
    while($result = $topic->fetch_object()) {
?>
<div class="panel" style="width:1000px; margin-left:auto; margin-right:auto;">
<div class="panel-body">
	<div class='col-md-3'>
	<div class="stat-panel text-left" style="width:1000px; margin-left:-32px; margin-right:auto; margin-top:-20px;">
		<div class="stat-row">
			<div class="stat-cell bg-dark-gray padding-sm text-xs text-semibold">
				<a href="https://rpcp.itp.lv/<?php echo $shout->topic_id; ?>-"><i class="fa  fa-share"></i> <?php echo $result->title; ?></a>
			</div>
		</div>
		<p></p>
<center>
...
<div class="table-footer" style="width:1000px; margin-left:auto; margin-right:auto; margin-top:0px;">
										Izveidoja <?php echo date("d.m.Y",$shout->post_date); ?> <div class = "author" style = "float:right;"> Autors: <?php echo $result->starter_name; ?> </div>
									</div>
									</div>
									<p></p>
<?php
